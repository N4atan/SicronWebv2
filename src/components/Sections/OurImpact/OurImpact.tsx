...
const featuredNGOs = [
    ...
    },
    {
        ...
        tag: 'Ambiente',
        title: 'Verde Vida',
        desc: 'Projetos de reflorestamento urbano e hortas comunitárias.',
        link: '#'
    }
];
    ...
    return (
        <section className="featured-section">
            <div className="featured-header">
                ...
                <p className="subtitle-section" style={{ marginBottom: 0 }}>
                    Organizações altamente avaliadas fazendo a diferença agora.
                </p>
